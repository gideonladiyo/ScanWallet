...
class _$ScanResultEntityImpl implements _ScanResultEntity {
  ...
  @override
  String toString() {
    return 'ScanResultEntity(amount: $amount, date: $date, merchant: $merchant, type: $type, source: $source, rawText: $rawText)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, amount, date, merchant, type, source, rawText);
